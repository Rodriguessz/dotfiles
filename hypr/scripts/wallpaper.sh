...
if [ -f ~/.config/setup/settings/wallpaper_cache ]; then
    use_cache=1
...
force_generate=0
generatedversions="$HOME/.config/setup/cache/wallpaper-generated"
waypaperrunning=$HOME/.config/setup/cache/waypaper-running
cachefile="$HOME/.config/setup/cache/current_wallpaper"
blurredwallpaper="$HOME/.config/setup/cache/blurred_wallpaper.png"
squarewallpaper="$HOME/.config/setup/cache/square_wallpaper.png"
rasifile="$HOME/.config/setup/cache/current_wallpaper.rasi"
blurfile="$HOME/.config/setup/settings/blur.sh"
defaultwallpaper="$HOME/.config/wallpapers/default.jpg"
wallpapereffect="$HOME/.config/setup/settings/wallpaper-effect.sh"
blur="50x30"
blur=$(cat $blurfile)
